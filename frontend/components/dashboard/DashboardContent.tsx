...
import { getChannels, getLeaderboard, getPlatformStats } from '@/lib/api';
import type { LeaderboardEntry, PlatformStats, YouTuber } from '@/types';
import {
  BarChart3,
  CheckCircle,
  LayoutGrid,
...
export const DashboardContent = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [channelsRes, leaderboardRes, statsRes] = await Promise.all([
        getChannels(),
        getLeaderboard(),
        getPlatformStats(),
      ]);
